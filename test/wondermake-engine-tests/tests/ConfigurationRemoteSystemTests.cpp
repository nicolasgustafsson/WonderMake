...
auto MakeConfigurationRemoteSystem(std::optional<Guid> aInstanceId = std::nullopt) -> std::tuple<SharedReference<ConfigurationSystem>, SharedReference<NiceMock<GuidGeneratorSystemMock>>, SharedReference<ConfigurationRemoteSystem>>
{
