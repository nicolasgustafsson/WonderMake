...
TEST_CASE("Guid assign copy copies and returns correctly.", "[Guid]")
{
	constexpr auto original = *Guid::Parse("4ae5a5f8-4ab7-4fe7-a48f-323d89b1925b");
	...
	REQUIRE(original == *Guid::Parse("4ae5a5f8-4ab7-4fe7-a48f-323d89b1925b"));
	REQUIRE(copyAssigned == *Guid::Parse("4ae5a5f8-4ab7-4fe7-a48f-323d89b1925b"));
}
